...
class ProductResourceTest {
    ...
    void get_por_id_devuelve_el_producto_existente() {
        ...
        given()
                .when().get("/inventory/products/" + id)
                .then()
                .statusCode(200)
                .body("id", equalTo(id))
    ...
    void get_por_id_inexistente_devuelve_404() {
        given()
                .when().get("/inventory/products/99999999")
                .then()
                .statusCode(404)
    ...
    void put_actualiza_nombre_y_cantidad_conservando_sku() {
        ...
        given()
                ...
                .when().put("/inventory/products/" + id)
                .then()
                .statusCode(200)
                .body("id", equalTo(id))
    ...
    void put_a_id_inexistente_devuelve_404() {
        given()
                ...
                .when().put("/inventory/products/99999999")
                .then()
                .statusCode(404)
                .body("message", containsString("99999999"));
    }
    ...
    void delete_elimina_el_producto_y_luego_da_404() {
        ...
        given()
                .when().delete("/inventory/products/" + id)
                .then().statusCode(204);
    ...
    void delete_a_id_inexistente_devuelve_404() {
        given()
                .when().delete("/inventory/products/99999999")
                .then()
                .statusCode(404)
                .body("message", containsString("99999999"));
    }
    ...
    void get_lista_los_productos_registrados() {
        given().contentType("application/json")
                ...
                .when().post("/inventory/products").then().statusCode(201);
        given().contentType("application/json")
                .body("{\"name\":\"Producto B\",\"sku\":\"LIST-B\",\"quantity\":3}")
                .when().post("/inventory/products").then().statusCode(201);

        given()
                .when().get("/inventory/products")
                .then()
                .statusCode(200)
